        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center gap-10 lg:px-16">
          ...
          <div className="w-full lg:w-1/2 text-left order-1 lg:order-2" >
            ...
            <Typography
              ...
              data-aos="fade-up"
            >
              {t("dr.facialService.title")}
            </Typography>

            <Typography color="gray" className="pb-5" data-aos="fade-up">
              {t("dr.facialService.description")}
            </Typography>

            <div data-aos="fade-up">
              <h6 className="font-medium text-base mb-5 text-gray-800">
                {t("dr.facialService.text")}
              </h6>
              <Accordion type="single" collapsible defaultValue="item-0">
                <AccordionItem value="item-1">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.0")}
                  </p>
                </AccordionItem>
                <AccordionItem value="item-2">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.1")}
                  </p>
                </AccordionItem>
                <AccordionItem value="item-3">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.2")}
                  </p>
                </AccordionItem>
                <AccordionItem value="item-4">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.3")}
                  </p>
                </AccordionItem>
                <AccordionItem value="item-5">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.4")}
                  </p>
                </AccordionItem>
                <AccordionItem value="item-6">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.5")}
                  </p>
                </AccordionItem>
                <AccordionItem value="item-7">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.6")}
                  </p>
                </AccordionItem>
                <AccordionItem value="item-8">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.7")}
                  </p>
                </AccordionItem>
                <AccordionItem value="item-9">
                  <p className="text-lg py-3">
                    {t("dr.facialService.list.8")}
                  </p>
                </AccordionItem>
              </Accordion>
            </div>
